      ...
      {messages.length === 0 && !isLoading && (
        <div className="flex flex-col items-center text-center mt-16">
          ...
          <div className="flex flex-wrap justify-center gap-2 mt-8 max-w-sm">
            <span className="px-3 py-2 bg-white/80 backdrop-blur-sm rounded-xl text-sm text-slate-600 shadow-sm border border-purple-100/50 hover:border-purple-200 transition-colors cursor-default">
              Pediatrician&apos;s number?
            </span>
            <span className="px-3 py-2 bg-white/80 backdrop-blur-sm rounded-xl text-sm text-slate-600 shadow-sm border border-teal-100/50 hover:border-teal-200 transition-colors cursor-default">
              Riley&apos;s teachers
            </span>
            <span className="px-3 py-2 bg-white/80 backdrop-blur-sm rounded-xl text-sm text-slate-600 shadow-sm border border-purple-100/50 hover:border-purple-200 transition-colors cursor-default">
              Dentist info
